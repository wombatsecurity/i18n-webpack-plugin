...
/**
 * Define a function to be used by Webpack for loading .i18n files
...
function loader( source ) {
	...
	if ( !this[NS] ) {
		...
		return `var fn = ${options.getTextGen( relative_path, key )}; ` +
			`fn.locales = [ "${_.reduce( json, ( memo, _, locale ) => {
